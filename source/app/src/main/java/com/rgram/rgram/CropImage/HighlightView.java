...
package com.rgram.rgram.CropImage;
...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                ResourcesCompat.getDrawable(resources, R.drawable.circle_arrow_vectical, null);
        mResizeDrawableHeight =
                ResourcesCompat.getDrawable(resources, R.drawable.circle_arrow_horizontal, null);
        mResizeDrawableDiagonal =
                ResourcesCompat.getDrawable(resources, R.drawable.circle_arrow_cross, null);
    }
